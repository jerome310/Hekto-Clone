    ...
    <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
        ...
        <div class="mb-6">
            ...
            <form class="flex flex-col space-y-4" method="POST" action="/">
                ...
                <textarea name="description" id="The todo description" placeholder="The description" class="py-3 px-4 bg-gray-100 rounded-xl"></textarea>
        ...
        <div class="mt-2">
            <div class="container py-4 flex items-center border-b border-gray-300 px-3">
                ...
                <div class="flex space-x-3">
                    <form method="POST" action="/{$todo->id}">
                        @csrf
                        @method('DELETE')
                        <button class="button py-2 px-2 bg-green-500 text-white rounded-xl">
